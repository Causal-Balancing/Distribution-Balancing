...
# ================================5. Plot====================================
cbind(taus,QTE_Epy3,se)
plot(taus,QTE_Epy3,type='l')

dele_point<-c(7,13,14,16)
taus_new<-taus[-dele_point]
QTE_Epy3_new<- QTE_Epy3[-dele_point]
ci_lower_new<-ci_lower[-dele_point]
ci_upper_new<-ci_upper[-dele_point]
cb_lower_new <- cb_lower[-dele_point]
cb_upper_new <- cb_upper[-dele_point]
#windows(15,9)
data_plot<-data.frame(cbind(taus_new,QTE_Epy3_new,ci_lower_new,ci_upper_new,
                            cb_lower_new,cb_upper_new))
library('ggplot2')
